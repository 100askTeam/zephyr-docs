...
编译、烧录和串口操作见[编译与烧录程序](../../00-学习准备/03-编译与烧录程序/README.md)，断点与单步操作见[使用 VS Code 调试程序](../../00-学习准备/04-使用VSCode调试程序/README.md)。需要对照芯片接口和板载器件时，查看[RA6M5 芯片与硬件](../01-RA6M5芯片与硬件/README.md)。
