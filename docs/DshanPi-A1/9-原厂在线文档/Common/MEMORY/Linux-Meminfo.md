...
active\_anon:43194 inactive\_anon:26284 isolated\_anon:0   

active\_file:35286 inactive\_file:17959 isolated\_file:0   

unevictable:806 dirty:0 writeback:0 unstable:0   

slab\_reclaimable:10164 slab\_unreclaimable:17630   

mapped:48836 shmem:1280 pagetables:10550 bounce:0   

free:134653 free\_pcp:717 free\_cma:0   

Node 0 active\_anon:172776kB inactive\_anon:105136kB active\_file:141144kB   

inactive\_file:71836kB unevictable:3224kB isolated(anon):0kB   

isolated(file):0kB mapped:195344kB dirty:0kB writeback:0kB shmeo   

DMA32 free:538612kB min:4884kB low:24024kB high:25520kB active\_anon:172776kB   

inactive\_anon:105136kB active\_file:141144kB inactive\_file:71836kB   

unevictable:3224kB writepending:0kB present:2095104kB   

lowmem\_reserve[]: 0 0 0   
...
[root@RV1126\_RV1109:/]# cat /proc/slabinfo |grep kernfs\_node\_cache   

kernfs\_node\_cache 18319 18340 144 28 1 : tunables 0 0 0 :   
...
[root@RV1126\_RV1109:/]# cat /proc/slabinfo |grep inode\_cache   

inode\_cache 6282 6340 408 20 2 : tunables 0 0 0 :   
...
752320K: 空闲页可用内存， nr\_free\_pages() &lt;&lt; (PAGE\_SHIFT - 10)

1048024K：总共可见物理内存， physpages &lt;&lt; (PAGE\_SHIFT - 10)

kernel code：内核代码， codesize = \_etext - \_stext

rwdata：可读可写数据段， datasize = \_edata - \_sdata

rodata：只读数据段， rosize = end\_rodata - start\_rodata

bss：用来存放程序中未初始化的全局变量的一块内存区域， bss\_size = \_\_bss\_stop - \_\_bss\_start

reserved：memblock预留内存， physpages - totalram\_pages - totalcma\_pages

cma-reserved：CMA预留内存， totalcma\_pages
...
[root@RV1126\_RV1109:/]# cat /sys/kernel/debug/memblock/memory   
...
[root@RV1126\_RV1109:/]# cat /sys/kernel/debug/memblock/reserved   
...
nr\_vmscan\_immediate\_reclaim 2540   

nr\_dirtied 798484   

nr\_written 938957   

nr\_kernel\_misc\_reclaimable 0   

nr\_unreclaimable\_pages 0   

nr\_ion\_heap 0   

nr\_ion\_heap\_pool 0   
...
nr\_free\_pages 133183   

nr\_zone\_inactive\_anon 28250   

nr\_zone\_active\_anon 34245   

nr\_zone\_inactive\_file 29724   

nr\_zone\_active\_file 33943   

nr\_zone\_unevictable 806   

nr\_zone\_write\_pending 31   

nr\_mlock 806   

nr\_page\_table\_pages 10425   

nr\_kernel\_stack 18256   
...
|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| Mem: | total 1533640704 | used 1308901376 | free 224739328 | shared 6422528 | buffers 921600 |
...
|  | free shared |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| Mem: | total 1462 | used 1249 | 213 | 6 | buffers 0 |
