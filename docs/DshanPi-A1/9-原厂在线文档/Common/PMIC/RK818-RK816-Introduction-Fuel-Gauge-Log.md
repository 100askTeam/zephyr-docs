...
| 芯片名称 | 内核版本 |
| --- | --- |
| RK818、RK816 | Linux4.4、Linux4.19 |
...
| 版本号 | 作者 | 修改日期 | 修改说明 |
| --- | --- | --- | --- |
| V1.0.0 | 陈健洪 | 2018-05-28 | 初始版本 |
| V1.1.0 | 陈健洪 | 2021-06-08 | 增加4.19内核 |
...
drivers/power/rk818\_battery.h
...
rk818-bat: changed: dsoc=22, rsoc=24, v=3820, ov=3770 c=1018, cap=960, f=4000,   

st=cc cv, hotdie=0   

rk818-bat: dl=10, rl=12, v=3670, halt=0, halt\_n=0, max=0, init=0, sw=0, calib=0,   
...
```html
rk818-bat: shutdown: dl=0 rl=2 c=-1220 v=3460 cap=88 f=4000 ch=1 n=0 mode=1
rest=128
打印含义：<显示soc> <真实soc> <电流> <电压> <剩余容量> <满充容量> <是否有charger> <其余忽
略....>
```
